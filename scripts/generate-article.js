...
const SITE_NAME = 'AI Productivity Lab';
const SITE_COLOR = '#9b59b6';
const fs = require('fs');
const path = require('path');

const TOPICS = [
  "Best AI Productivity Tools 2026: Ultimate Ranking",
  "Notion AI vs Obsidian AI: Which Note-Taking App Wins?",
  "How to Build a Second Brain with AI Tools",
  "Best AI Calendar and Scheduling Assistants",
  "AI Meeting Assistants: Otter vs Fireflies vs Fathom",
  "How to Use AI to Manage Email Overload",
  "Best AI Task Management Tools: Todoist AI vs Others",
  "AI Tools for Deep Work and Focus Sessions",
  "How to Automate Repetitive Tasks with AI in 2026",
  "Best AI Tools for Project Management Teams",
  "AI Writing Assistants for Faster Content Creation",
  "How to Use AI to Read and Summarize Documents Faster",
  "Best AI Browser Extensions for Daily Productivity",
  "AI Tools for Remote Workers: The Essential Toolkit",
  "How to Create Automated Workflows with AI and No-Code"
];
